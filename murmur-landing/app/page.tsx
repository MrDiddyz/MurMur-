...
/* ---------------------- Constellation Animated Hero ---------------------- */

function ConstellationHero() {
  // No canvas, no deps. Pure CSS animation.
  return (
...
function Node({
  ...
  return (
    <div className={`absolute ${className}`} style={{ animation: "murmurFloat 6s ease-in-out infinite" }}>
      <div className="relative">
        {/* pulse ring */}
        <div
          className="absolute inset-0 rounded-full"
          style={{
            boxShadow: "0 0 0 1px rgba(230,193,90,0.25)",
          }}
        />
        <div
